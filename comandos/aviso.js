...
let on = message.guild.users.filter(m => m.presence.status === 'online')
let npertube = message.guild.users.filter(m => m.presence.status === 'dnd')
let ausente = message.guild.users.filter(m => m.presence.status === 'idle')
