...
if (message.author.id !== '283482289911103489', '611627807440896020') return message.reply("<:7775:593645935280783431> | você não possui permissão para usar esse comando.");
message.delete()
