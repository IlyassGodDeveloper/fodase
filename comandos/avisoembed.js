...
exports.run = async (bot, message, args) => {
  if(!message.member.hasPermission("ADMINISTRATOR") && message.author.id !== '568234099093798923') return message.reply(":x: | você não possui permissão para usar esse comando.")
